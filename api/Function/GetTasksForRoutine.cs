...
public static class GetTasksForRoutine
{
    ...
    public static IEnumerable<FamilyCommandCenter.Data.Task> Run(
        ...
        [SqlInput("select * from Task task join RoutineTask routineTask on task.TaskId = routineTask.TaskId where routineTask.RoutineId = @RoutineId; ", "SqlConnectionString", parameters: "@RoutineId={routineId}")] IEnumerable<FamilyCommandCenter.Data.Task> tasks)
    {
        return tasks;
    }
}